...
Program-1
Jackson Tran
This program will image manipulation functions that are within
...
public:
	...
	Parameters:
	string input - the text file that you are reading from
	string output - the text file that you are writing to
	Returns: void
	*/
...
int main() {
	...
	imageInfo.grayScale("bot.txt", "bot2.txt");
	imageInfo.flipHorz("bot2.txt", "bot2.txt");
	imageInfo.flipVert("bot2.txt", "bot2.txt");
